  ...
  class UploadMessageExtensionPreviousPerson
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'callName')
        self.call_name = attributes[:'callName']
      end
      ...
      if attributes.has_key?(:'nationalityISO2')
        self.nationality_iso2 = attributes[:'nationalityISO2']
      end
    ...
    def list_invalid_properties
      ...
      if !@sex.nil? && @sex > 3.0
        invalid_properties.push("invalid value for 'sex', must be smaller than or equal to 3.0.")
      end

      if !@sex.nil? && @sex < 1.0
        invalid_properties.push("invalid value for 'sex', must be greater than or equal to 1.0.")
      end
    ...
    def sex=(sex)
      ...
      if !sex.nil? && sex > 3.0
        fail ArgumentError, "invalid value for 'sex', must be smaller than or equal to 3.0."
      end

      if !sex.nil? && sex < 1.0
        fail ArgumentError, "invalid value for 'sex', must be greater than or equal to 1.0."
      end
